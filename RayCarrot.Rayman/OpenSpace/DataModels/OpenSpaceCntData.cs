...
namespace RayCarrot.Rayman
{
    ...
    public class OpenSpaceCntData : IBinarySerializable
    {
        ...
        /// </summary>
        public Dictionary<string, Func<byte[]>> FileGenerator { get; set; }
        ...
        public void Serialize(BinaryDataWriter writer)
        {
            ...
            if (FileGenerator == null)
                throw new Exception("The .cnt file can't be serialized without a file generator");
            ...
            foreach (var file in Files)
            {
                ...
                writer.Write(FileGenerator[fullPath].Invoke());
            }
        }
