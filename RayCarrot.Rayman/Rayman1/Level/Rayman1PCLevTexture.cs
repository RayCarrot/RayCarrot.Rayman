...
{
    /// <summary>
    /// The data for a 16x16 texture for a Rayman 1 .lev file on PC
    /// </summary>
    public class Rayman1PCLevTexture : IBinarySerializable<Rayman1Settings>
    {
        /// <summary>
        ...
        public virtual void Deserialize(IBinaryDataReader<Rayman1Settings> reader)
        {
            // Set the color array
        ...
        public virtual void Serialize(IBinaryDataWriter<Rayman1Settings> writer)
        {
            for (int y = 0; y < Size; y++)
            {
                for (int x = 0; x < Size; x++)
