...
namespace RayCarrot.Rayman
{
    ...
    /// </summary>
    public class R2UbiIniHandler : UbiIniHandler
    {
        #region Constructor
        ...
        public R2UbiIniHandler(FileSystemPath path, string sectionName) : base(path, sectionName)
        {
        }
        ...
        /// </summary>
        /// <param name="path">The path of the ubi.ini file</param>
        public R2UbiIniHandler(FileSystemPath path) : base(path, SectionName)
        {
        }
